...
function WhySaja({ lang }) {
  ...
  return (
    <section id="why-saja" className="border-t border-border-subtle py-20 md:py-28">
      <Reveal>
      <Container>
        <SectionHeader title={whySaja.title[lang]} />

        <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-border-subtle bg-card/60 p-6 backdrop-blur-md sm:p-10">
