...
function Services({ lang }) {
  ...
  return (
    <section id="services" className="border-t border-white/5 py-20 md:py-28">
      <Reveal>
      <Container>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {services.items.map((service) => (
            <div
              ...
              className="flex flex-col gap-3 rounded-2xl border border-white/5 bg-card/60 p-6 backdrop-blur-md transition-all duration-200 hover:-translate-y-1 hover:border-primary/40"
            >
